...
import './index.css';
import { CONTENT_PLAN } from './contentPlan.js';
...
export default function App() {
  ...
  const [appMode, setAppMode] = useState("calendar"); // Default to CMO 14-day calendar
  ...
  // --- V4 Content Plan (The CMO Edition: 14 Days, 42 Videos) imported from ./contentPlan.js ---
